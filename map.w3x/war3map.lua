...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("N000"), -2301.0, 2560.5, 311.160, FourCC("N000"))
end
...
function InitGameCore()
	...
	HERO[0]={
		...
		ReleaseRMB=false,
		SpeedBase=9,
		UnitHero=CreateUnit(Player(0), FourCC('N000'), GetPlayerStartLocationX(Player(0)), GetPlayerStartLocationY(Player(0)), 0),
		CurrentSpeed=0,
		WeaponIndex=1,
